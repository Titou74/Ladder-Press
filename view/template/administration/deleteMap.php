...
<div class="wrap">
    ...
    <p>Are you sure you want to delete <strong>"<?php echo $deleteMap->getName() ?>"</strong> ? This action can't be undo.</p>
    ...
    <form style="display:inline;" action="admin.php?page=ladder_press_maps" method="post">
        <input id="submit" class="button" type="submit" value="No, back to maps list" name="submit" />
    </form>
</div>