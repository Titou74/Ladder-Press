...
<div class="wrap">
    ...
    <p>Etes vous sûr de vouloir quitter l'équipe : <strong><?php echo $team->getName() ?></strong></p>
    
    <form style="display:inline;" method="post" action="?p=users">
        <input type="hidden" name="ladder_press_leave_team_id" value="<?php echo $team->getId() ?>"/>
